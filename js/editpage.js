    ...
    geocoder.geocode( { 'address': address}, function(results, status) {
      if (status == 'OK') {
        ...
        infowindow = new google.maps.InfoWindow({
          ...
          document.getElementById('showd_name').value = results[0].address_components[0].short_name;
          document.getElementById('showd_lat').value = results[0].geometry.location.lat();
          document.getElementById('showd_log').value = results[0].geometry.location.lng();
...
//   let name =  document.getElementById('showd_name').value
//   let lat = document.getElementById('showd_lat').value
//   let lng = document.getElementById('showd_log').value
